...
interface BlockAccessor {
  ...
  /**
   * Sets the given block at [pos] as AIR.
   */
  fun setAir(pos: Pos) = setBlock(pos, Blocks.AIR)

  /**
   * Sets the given block at the given coordinates as AIR.
   */
  fun setAir(x: Int, y: Int, z: Int) = setBlock(x, y, z, Blocks.AIR)
