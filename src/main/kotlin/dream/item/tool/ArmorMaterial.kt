...
data class ArmorMaterial(
  ...
  companion object {
    @JvmField
    val LEATHER = ArmorMaterial(5, 1, 3, 2, 1, 15, true, Items.AIR)
    @JvmField
    val CHAIN = ArmorMaterial(15, 2, 5, 4, 1, 12, false, Items.AIR)
    @JvmField
    val IRON = ArmorMaterial(15, 2, 6, 5, 2, 9, false, Items.AIR)
    @JvmField
    val GOLD = ArmorMaterial(7, 2, 5, 3, 1, 25, false, Items.AIR)
    @JvmField
    val DIAMOND = ArmorMaterial(33, 3, 8, 6, 3, 10, false, Items.AIR)
  }
