...
object Crypt {
   ...
   @JvmField val KEY_GENERATOR: KeyGenerator = KeyGenerator.getInstance("AES").apply { init(128) }
   @JvmField val KEY_FACTORY: KeyFactory = KeyFactory.getInstance("RSA")
   @JvmField val KEY_PAIR_GENERATOR: KeyPairGenerator = KeyPairGenerator.getInstance("RSA").apply { initialize(1024) }
