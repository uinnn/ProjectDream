...
class NetworkManager(val direction: PacketDirection) : PacketChannelHandler() {
   ...
   override fun channelRead0(ctx: ChannelHandlerContext, msg: Packet<PacketHandler>) {
      if (!channel.isOpen || !msg.canReceive(this))
         return
   ...
   companion object {
      ...
      @JvmField val ATTRIBUTE_CONNECTION: AttributeKey<ConnectionState> = AttributeKey.valueOf("protocol")
