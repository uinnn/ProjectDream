...
class OpenDoubleRange(start: Double, endExclusive: Double) {
...
/**
 * Creates and returns an open range by this double and the specified [end].
 */
infix fun Double.openRange(end: Double) = OpenDoubleRange(this, end)
