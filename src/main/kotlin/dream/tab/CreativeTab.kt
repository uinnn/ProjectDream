...
abstract class CreativeTab(val index: Int, override val unlocalName: String) : Locale {
   ...
   companion object Registry {
       ...
       * All creative tabs.
       */
      @JvmField val TABS = ArrayList<CreativeTab>(12)
      
      @JvmField val BLOCKS = tab(0, "buildingBlocks", Items.AIR)
      @JvmField val DECORATIONS = tab(1, "decorations", Items.AIR)
      @JvmField val REDSTONE = tab(2, "redstone", Items.AIR)
      @JvmField val TRANSPORT = tab(3, "transportation", Items.AIR)
      @JvmField val MISC = tab(4, "misc", Items.AIR)
      @JvmField val SEARCH = tab(5, "search", Items.AIR)
      @JvmField val FOODS = tab(6, "food", Items.AIR)
      @JvmField val TOOLS = tab(7, "tools", Items.AIR)
      @JvmField val COMBAT = tab(8, "combat", Items.AIR)
      @JvmField val BREWING = tab(9, "brewing", Items.AIR)
      @JvmField val MATERIALS = tab(10, "materials", Items.AIR)
      @JvmField val INVENTORY = tab(11, "inventory", Items.AIR)
   }
}
