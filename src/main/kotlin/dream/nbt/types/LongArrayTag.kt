 ...
 */
class LongArrayTag : LongList, ArrayTag, Serializable {
  ...
  //constructor(vararg elements: Long) : super(elements)
...
fun longArrayTagOf(vararg elements: Long) = LongArrayTag(elements)
