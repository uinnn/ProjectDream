...
class Watcher(val entity: Entity) {
   ...
   /**
    * The lock of this watcher.
    */
   protected var lock: ReadWriteLock = ReentrantReadWriteLock()
   ...
   val allChanged: List<WatcherValue>
      get() {
         ...
         return lock.readLock().withLock {
            val list = ArrayList<WatcherValue>()
   ...
   fun add(id: Int, value: Any): Watcher {
      ...
      val obj = WatcherValue(id(value::class), id, value)
    ...
    */
   fun item(id: Int, default: ItemStack = ItemStack.AIR): ItemStack {
      return valueOrNull(id) ?: default
   }
